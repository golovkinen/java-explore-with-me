...
public class EventController {
    ...
    public EventFullDto createEventPrivate(@Valid @RequestBody NewEventDto newEventDto,
    ...
    public List<EventShortDto> findAllEventsOrderedByDistance(@Valid @RequestBody LocationDto locationDto,
    ...
    public List<EventShortDto> findAllEventsWithinRadius(@Valid @RequestBody LocationDto locationDto,
    ...
    public List<EventFullDto> getEventsBySubscriptions(@Positive @PathVariable(name = "userId") int userId,
                                                       @RequestParam(name = "ids", required = false) Optional<List<Integer>> ids,
                                                       @PositiveOrZero @RequestParam(name = "from", defaultValue = "0") int from,
                                                       @Positive @RequestParam(name = "size", defaultValue = "10") int size) {
