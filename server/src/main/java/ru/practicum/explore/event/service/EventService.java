...
public class EventService implements IEventService {
    ...
    public List<EventShortDto> getAllPublic(String text, List<Integer> categories, Boolean paid, String rangeFrom, String rangeEnd,
        ...
        if ((text == null || text.isBlank()) && onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIs(onlyAvailable, pageable).getContent();
        }
        ...
        if ((text == null || text.isBlank()) && onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndEventDateBefore(onlyAvailable, EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }
        ...
        if ((text == null || text.isBlank()) && onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndEventDateAfter(onlyAvailable, EventMapper.toDateTime(rangeFrom), pageable).getContent();
        }
        ...
        if ((text == null || text.isBlank()) && onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndEventDateBetween(onlyAvailable, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }
        ...
        if ((text == null || text.isBlank()) && onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdIn(onlyAvailable, categories, pageable).getContent();
        }
        ...
        if ((text == null || text.isBlank()) && onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndEventDateBefore(onlyAvailable, categories, EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }
        ...
        if ((text == null || text.isBlank()) && onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndEventDateAfter(onlyAvailable, categories, EventMapper.toDateTime(rangeFrom), pageable).getContent();
        }
        ...
        if ((text == null || text.isBlank()) && onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndEventDateBetween(onlyAvailable, categories, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }
        ...
        if ((text == null || text.isBlank()) && onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIs(onlyAvailable, paid, pageable).getContent();
        }

        if ((text == null || text.isBlank()) && !onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByPaidIs(paid, pageable).getContent();
        }

        //все мероприятия paid и с категориями
        if ((text == null || text.isBlank()) && onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndCategoryIdIn(onlyAvailable, paid, categories, pageable).getContent();
        }

        if ((text == null || text.isBlank()) && !onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByPaidIsAndCategoryIdIn(paid, categories, pageable).getContent();
        }

        //все мероприятия paid не позже даты
        if ((text == null || text.isBlank()) && onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndEventDateBefore(onlyAvailable, paid, EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }

        if ((text == null || text.isBlank()) && !onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByPaidIsAndEventDateBefore(paid, EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }

        //все мероприятия paid начиная с даты
        if ((text == null || text.isBlank()) && onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndEventDateAfter(onlyAvailable, paid, EventMapper.toDateTime(rangeFrom), pageable).getContent();
        }

        if ((text == null || text.isBlank()) && !onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByPaidIsAndEventDateAfter(paid, EventMapper.toDateTime(rangeFrom), pageable).getContent();
        }

        //все мероприятия paid в промежутке
        if ((text == null || text.isBlank()) && onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndEventDateBetween(onlyAvailable, paid, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }

        if ((text == null || text.isBlank()) && !onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByPaidIsAndEventDateBetween(paid, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }

        //все мероприятия Paid и с категориями не позже даты
        if ((text == null || text.isBlank()) && onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndCategoryIdInAndEventDateBefore(onlyAvailable, paid, categories, EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }

        if ((text == null || text.isBlank()) && !onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByPaidIsAndCategoryIdInAndEventDateBefore(paid, categories, EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }

        //все мероприятия paid и с категориями начиная с даты
        if ((text == null || text.isBlank()) && onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndCategoryIdInAndEventDateAfter(onlyAvailable, paid, categories, EventMapper.toDateTime(rangeFrom), pageable).getContent();
        }

        if ((text == null || text.isBlank()) && !onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByPaidIsAndCategoryIdInAndEventDateAfter(paid, categories, EventMapper.toDateTime(rangeFrom), pageable).getContent();
        }

        //все мероприятия paid и с категориями в промежутке
        if ((text == null || text.isBlank()) && onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndCategoryIdInAndEventDateBetween(onlyAvailable, paid, categories, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }

        if ((text == null || text.isBlank()) && !onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByPaidIsAndCategoryIdInAndEventDateBetween(paid, categories, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), pageable).getContent();
        }

        //все мероприятия поиск по text
        if (text != null && onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(text, text, pageable).getContent();
        }

        //все мероприятия поиск по text не позже даты
        if (text != null && onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        //все мероприятия поиск по text начиная с даты
        if (text != null && onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, EventMapper.toDateTime(rangeFrom), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(EventMapper.toDateTime(rangeFrom), text, text, pageable).getContent();
        }

        //все мероприятия поиск по text в промежутке
        if (text != null && onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и paid
        if (text != null && onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, paid, text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByPaidIsAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(paid, text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и paid не позже даты
        if (text != null && onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, paid, EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByPaidIsAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(paid, EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и paid начиная с даты
        if (text != null && onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, paid, EventMapper.toDateTime(rangeFrom), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByPaidIsAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(paid, EventMapper.toDateTime(rangeFrom), text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и paid в промежутке
        if (text != null && onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndPaidIsAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, paid, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByPaidIsAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(paid, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и с категориями
        if (text != null && onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, categories, text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByCategoryIdInAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(categories, text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и с категориями не позже даты
        if (text != null && onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, categories, EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByCategoryIdInAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(categories, EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и с категориями начиная с даты
        if (text != null && onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, categories, EventMapper.toDateTime(rangeFrom), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByCategoryIdInAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(categories, EventMapper.toDateTime(rangeFrom), text, text, pageable).getContent();
        }
        //все мероприятия поиск по text и с категориями в промежутке
        if (text != null && onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, categories, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && !categories.isEmpty() && paid == null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByCategoryIdInAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(categories, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и paid и с категориями
        if (text != null && onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndPaidIsAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, categories, paid, text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd == null) {
            events = iEventRepository.findAllByCategoryIdInAndPaidIsAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(categories, paid, text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и paid и с категориями не позже даты
        if (text != null && onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndPaidIsAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, categories, paid, EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom == null && rangeEnd != null) {
            events = iEventRepository.findAllByCategoryIdInAndPaidIsAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(categories, paid, EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и paid и с категориями начиная с даты
        if (text != null && onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndPaidIsAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, categories, paid, EventMapper.toDateTime(rangeFrom), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd == null) {
            events = iEventRepository.findAllByCategoryIdInAndPaidIsAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(categories, paid, EventMapper.toDateTime(rangeFrom), text, text, pageable).getContent();
        }

        //все мероприятия поиск по text и paid и с категориями в промежутке
        if (text != null && onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByAvailableIsAndCategoryIdInAndPaidIsAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(onlyAvailable, categories, paid, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }

        if (text != null && !onlyAvailable && !categories.isEmpty() && paid != null &&
                rangeFrom != null && rangeEnd != null) {
            events = iEventRepository.findAllByCategoryIdInAndPaidIsAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(categories, paid, EventMapper.toDateTime(rangeFrom), EventMapper.toDateTime(rangeEnd), text, text, pageable).getContent();
        }
        ...
        if (events.size() > 1) {
            ...
            Comparator<Event> comparatorAsc = Comparator.comparing(Event::getPublishedOn);
        ...
        List<ViewStatDto> statList = eventClient.getStat(events.get(0).getPublishedOn(), timestamp, urisList, true);
