...
public interface IEventRepository extends JpaRepository<Event, Integer> {
    ...
    Page<Event> findAllByAvailableIsAndCategoryIdIn(Boolean available, Collection<Integer> categoryId, Pageable pageable);

    Page<Event> findAllByAvailableIsAndCategoryIdInAndEventDateBefore(Boolean available, Collection<Integer> categoryId, LocalDateTime eventDate, Pageable pageable);

    Page<Event> findAllByAvailableIsAndCategoryIdInAndEventDateAfter(Boolean available, Collection<Integer> categoryId, LocalDateTime eventDate, Pageable pageable);

    Page<Event> findAllByAvailableIsAndCategoryIdInAndEventDateBetween(Boolean available, Collection<Integer> categoryId, LocalDateTime eventDate, LocalDateTime eventDate2, Pageable pageable);

    Page<Event> findAllByAvailableIsAndPaidIs(Boolean available, Boolean paid, Pageable pageable);

    Page<Event> findAllByAvailableIsAndPaidIsAndCategoryIdIn(Boolean available, Boolean paid, Collection<Integer> categoryId, Pageable pageable);
    ...
    Page<Event> findAllByAvailableIsAndPaidIsAndCategoryIdInAndEventDateBefore(Boolean available, Boolean paid, Collection<Integer> categoryId, LocalDateTime eventDate, Pageable pageable);

    Page<Event> findAllByAvailableIsAndPaidIsAndCategoryIdInAndEventDateAfter(Boolean available, Boolean paid, Collection<Integer> categoryId, LocalDateTime eventDate, Pageable pageable);

    Page<Event> findAllByAvailableIsAndPaidIsAndCategoryIdInAndEventDateBetween(Boolean available, Boolean paid, Collection<Integer> categoryId, LocalDateTime eventDate, LocalDateTime eventDate2, Pageable pageable);
    ...
    Page<Event> findAllByAvailableIsAndCategoryIdInAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Boolean available, Collection<Integer> categoryId, String text1, String text2, Pageable pageable);

    Page<Event> findAllByAvailableIsAndCategoryIdInAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Boolean available, Collection<Integer> categoryId, LocalDateTime eventDate, String text1, String text2, Pageable pageable);

    Page<Event> findAllByAvailableIsAndCategoryIdInAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Boolean available, Collection<Integer> categoryId, LocalDateTime eventDate, String text1, String text2, Pageable pageable);

    Page<Event> findAllByAvailableIsAndCategoryIdInAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Boolean available, Collection<Integer> categoryId, LocalDateTime eventDate, LocalDateTime eventDate2, String text1, String text2, Pageable pageable);

    Page<Event> findAllByAvailableIsAndCategoryIdInAndPaidIsAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Boolean available, Collection<Integer> categoryId, Boolean paid, String text1, String text2, Pageable pageable);

    Page<Event> findAllByAvailableIsAndCategoryIdInAndPaidIsAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Boolean available, Collection<Integer> categoryId, Boolean paid, LocalDateTime eventDate, String text1, String text2, Pageable pageable);

    Page<Event> findAllByAvailableIsAndCategoryIdInAndPaidIsAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Boolean available, Collection<Integer> categoryId, Boolean paid, LocalDateTime eventDate, String text1, String text2, Pageable pageable);

    Page<Event> findAllByAvailableIsAndCategoryIdInAndPaidIsAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Boolean available, Collection<Integer> categoryId, Boolean paid, LocalDateTime eventDate, LocalDateTime eventDate2, String text1, String text2, Pageable pageable);


    Page<Event> findAllByPaidIs(Boolean paid, Pageable pageable);

    Page<Event> findAllByPaidIsAndCategoryIdIn(Boolean paid, Collection<Integer> categoryId, Pageable pageable);
    ...
    Page<Event> findAllByPaidIsAndCategoryIdInAndEventDateBefore(Boolean paid, Collection<Integer> categoryId, LocalDateTime eventDate, Pageable pageable);

    Page<Event> findAllByPaidIsAndCategoryIdInAndEventDateAfter(Boolean paid, Collection<Integer> categoryId, LocalDateTime eventDate, Pageable pageable);

    Page<Event> findAllByPaidIsAndCategoryIdInAndEventDateBetween(Boolean paid, Collection<Integer> categoryId, LocalDateTime eventDate, LocalDateTime eventDate2, Pageable pageable);
    ...
    Page<Event> findAllByCategoryIdInAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Collection<Integer> categoryId, String text1, String text2, Pageable pageable);

    Page<Event> findAllByCategoryIdInAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Collection<Integer> categoryId, LocalDateTime eventDate, String text1, String text2, Pageable pageable);

    Page<Event> findAllByCategoryIdInAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Collection<Integer> categoryId, LocalDateTime eventDate, String text1, String text2, Pageable pageable);

    Page<Event> findAllByCategoryIdInAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Collection<Integer> categoryId, LocalDateTime eventDate, LocalDateTime eventDate2, String text1, String text2, Pageable pageable);

    Page<Event> findAllByCategoryIdInAndPaidIsAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Collection<Integer> categoryId, Boolean paid, String text1, String text2, Pageable pageable);

    Page<Event> findAllByCategoryIdInAndPaidIsAndEventDateBeforeAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Collection<Integer> categoryId, Boolean paid, LocalDateTime eventDate, String text1, String text2, Pageable pageable);

    Page<Event> findAllByCategoryIdInAndPaidIsAndEventDateAfterAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Collection<Integer> categoryId, Boolean paid, LocalDateTime eventDate, String text1, String text2, Pageable pageable);

    Page<Event> findAllByCategoryIdInAndPaidIsAndEventDateBetweenAndAnnotationContainingIgnoreCaseOrDescriptionContainingIgnoreCase(Collection<Integer> categoryId, Boolean paid, LocalDateTime eventDate, LocalDateTime eventDate2, String text1, String text2, Pageable pageable);
