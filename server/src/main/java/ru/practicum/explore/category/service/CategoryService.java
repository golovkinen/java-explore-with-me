...
public class CategoryService implements ICategoryService {
    ...
    public CategoryDto updateCategory(CategoryDto categoryDto) {
        ...
        if (categoryDto.getName() != null) {
            if (categoryDto.getName().equals(iCategoryRepository.findByName(categoryDto.getName()))) {
                log.error("NotFoundException: {}", "Категория : " + categoryDto.getName() + " уже существует");
                throw new BadRequestException("Категория : " + categoryDto.getName() + " уже существует");
            }
