...
/*
	...
	void test1() {
		...
		ru.practicum.explore.item.model.Event event = new ru.practicum.explore.item.model.Event(1, "Item1", "Item1 Descr", true, user1, new HashSet<>(), new HashSet<>(), null);
		Booking lastBooking = new Booking(1, LocalDateTime.of(2022, 10, 1, 10, 00, 00),
				LocalDateTime.of(2022, 10, 2, 10, 00, 00), Status.WAITING, event, user2);
		Booking nextBooking = new Booking(2, LocalDateTime.of(2022, 11, 1, 10, 00, 00),
				LocalDateTime.of(2022, 11, 2, 10, 00, 00), Status.WAITING, event, user2);
		...
		ItemInfoDto itemInfoDto = ItemMapper.toItemDto(event, Optional.empty(), Optional.empty());
	...
	void test2() {
		...
		ru.practicum.explore.item.model.Event event = new ru.practicum.explore.item.model.Event(1, "Item1", "Item1 Descr", true, user1, new HashSet<>(), new HashSet<>(), request);
		Booking lastBooking = new Booking(1, LocalDateTime.of(2022, 10, 1, 10, 00, 00),
				LocalDateTime.of(2022, 10, 2, 10, 00, 00), Status.WAITING, event, user2);
		Booking nextBooking = new Booking(2, LocalDateTime.of(2022, 11, 1, 10, 00, 00),
				LocalDateTime.of(2022, 11, 2, 10, 00, 00), Status.WAITING, event, user2);
	...
	void test3() {
		...
		ru.practicum.explore.item.model.Event event = new ru.practicum.explore.item.model.Event(1, "Item1", "Item1 Descr", true, user1, new HashSet<>(), comments, request);
	...
	void test4() {
		...
		Set<Comment> comments = Collections.singleton(comment);
		ru.practicum.explore.item.model.Event event = new ru.practicum.explore.item.model.Event(1, "Item1", "Item1 Descr", true, user1, new HashSet<>(), comments, null);
	...
	void test5() {
		...
		ItemInfoDto itemInfoDto = ItemMapper.toItemDto(event, Optional.of(lastBooking), Optional.empty());
	...
	void test9() {
		...
		ItemInfoDto itemInfoDto = ItemMapper.toItemDto(event, Optional.empty(), Optional.of(nextBooking));
	...
	void test13() {
		...
		ItemInfoDto itemInfoDto = ItemMapper.toItemDto(event, Optional.of(lastBooking), Optional.of(nextBooking));
