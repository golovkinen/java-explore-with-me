...
/*    @Autowired
    ...
    @Test
    @Order(7)
    @DisplayName("GET /admin/users - Not Found")
    ...
    @Test
    @Order(8)
    @DisplayName("PATCH /user/5 - Not Found")
    void testUpdateUserNotFound() throws Exception {
        mockMvc.perform(patch("/user/{id}", 5)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    @Order(22)
    @DisplayName("POST /admin/categories Создаю category OK")
    void testCreateCategoryOk() throws Exception {

        NewCategoryDto newCategoryDto = new NewCategoryDto("category1");
    ...
    @Test
    @Order(23)
    @DisplayName("POST /admin/categories Создаю category name null")
    void testCreateCategoryNameNull() throws Exception {
    ...
    @Test
    @Order(24)
    @DisplayName("POST /admin/categories Создаю category name blank")
    void testCreateCategoryNameBlank() throws Exception {
    ...
    @Order(25)
    @DisplayName("POST /admin/categories Создаю category OK")
    void testCreateCategory2Ok() throws Exception {

        NewCategoryDto newCategoryDto = new NewCategoryDto("category2");
    ...
    @Order(26)
    @DisplayName("POST /admin/categories Создаю category OK")
    void testCreateCategory3Ok() throws Exception {

        NewCategoryDto newCategoryDto = new NewCategoryDto("category3");
        ...
        mockMvc.perform(post("/admin/categories")
                ...
                // Validate the returned fields
                .andExpect(jsonPath("$.id", is(3)))
                .andExpect(jsonPath("$.name", is("category3")));
    }

    @Test
    @Order(27)
    @DisplayName("PATCH /admin/categories Изменяю category OK")
    void testUpdateCategory3Ok() throws Exception {

        CategoryDto categoryDto = new CategoryDto(3, "Updatedcategory3");
        ...
        mockMvc.perform(patch("/admin/categories")
                ...
                // Validate the returned fields
                .andExpect(jsonPath("$.id", is(3)))
                .andExpect(jsonPath("$.name", is("Updatedcategory3")));
    }

    @Test
    @Order(28)
    @DisplayName("GET /categories Получаю все Categories OK")
    void testGetAllCategoriesOk() throws Exception {
        ...
        mockMvc.perform(get("/categories")
                ...
                .andExpect(jsonPath("$[2].name", is("Updatedcategory3")));
    }

    @Test
    @Order(29)
    @DisplayName("GET /categories/{id} Получаю Categories by ID OK")
    void testGetCategoryByIdOk() throws Exception {
    ...
    @Test
    @Order(30)
    @DisplayName("GET /categories/{id} Получаю Categories by ID NotFound")
    void testGetCategoryByIdNotFound() throws Exception {

        mockMvc.perform(get("/categories/{id}", 10)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    @Test
    @Order(31)
    @DisplayName("PATCH /admin/categories Изменяю category Not FOund")
    void testUpdateCategoryNotFound() throws Exception {

        CategoryDto categoryDto = new CategoryDto(10, "Updatedcategory3");
    ...
    void testCreateItemRequest2NotFound() throws Exception {
        ...
        NewEventDto newItem = new NewEventDto(null, "Item", "Some Item from Request", true, 2);
    ...
    void testCreateItemRequest1Ok() throws Exception {
        ...
        NewEventDto newItem = new NewEventDto(null, "Item", "Some Item from Request", true, 1);
    ...
    void testCreateItem9Ok() throws Exception {
        ...
        NewEventDto newItem = new NewEventDto(null, "Item2", "Some Item2 ", true, null);
